...
public class Login_08_Dynamic_Locator_Rest_Pram extends AbstractTest {
    ...
    public void TC_02_switchPage(){
        ...
        mediaPage = (MediaPageObject) postPage.selectPageMenu(driver, "Media");
        //switch to Links Page
        linkPage = (LinkPageObject) mediaPage.selectPageMenu(driver, "Link");
    }
